...
//go:generate swagger generate server --target .. --name pca --spec ../api/swagger.yaml

func configureFlags(api *operations.PcaAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.PcaAPI) http.Handler {
